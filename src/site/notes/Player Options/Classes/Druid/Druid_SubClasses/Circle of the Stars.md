---
{"dg-publish":true,"permalink":"/player-options/classes/druid/druid-sub-classes/circle-of-the-stars/"}
---
...
While holding the map, you have the [[Player Options/Spells/Detailed Spells/Guidance\|Guidance]] and [[Player Options/Spells/Detailed Spells/Guiding Bolt\|Guiding Bolt]] spells prepared, and you can cast [[Player Options/Spells/Detailed Spells/Guiding Bolt\|Guiding Bolt]] without expending a spell slot. You can cast it in that way a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
- _**Weal (Even).**_ Whenever a creature you can see within 30 feet of you is about to make a D20 Test, you can take a Reaction to roll 1d6 and add the number rolled to the total. 
- _**Woe (Odd).**_ Whenever a creature you can see within 30 feet of you is about to make a D20 Test, you can take a Reaction to roll 1d6 and subtract the number rolled from the total. You can use this Reaction a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
