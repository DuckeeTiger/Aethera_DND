...
| **Saving Throws Proficiencies** | D10 per Paladin level                                                                                             |
...
- Gain from Core Paladin Traits: Hit Point Die, proficiency with **Martial weapons**, and training with **Light & Medium armor** and **Shields**.
- Gain the Paladin’s level 1 features (spell slots follow multiclass rules). 

## Paladin Class Features

As a Paladin, you gain the following class features when you reach the specified Paladin levels. (Spell slots by level appear below.)
...
>
**_Prepared Spells of Level 1+_**. You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Paladin spells. Heroism and Searing Smite are recommended.
>
...
**_Spellcasting Focus._** You can use a Holy Symbol as a Spellcasting Focus for your Paladin spells.
 ...
 > [!paladin-feature] Weapon Mastery
...
---
#### Level 2 Features
> [!paladin-feature] Fighting Style
...
> [!paladin-feature] Paladin’s Smite
You always have the Divine Smite spell prepared. In addition, you can cast it without expending a spell slot, but you must finish a Long Rest before you can cast it in this way again.

---
#### Level 3 Features:
> [!paladin-feature] Channel Divinity
...
> [!paladin-feature] Paladin Subclass
...
---
#### Level 4 Features: 
> [!paladin-feature] Ability Score Improvement
...
---
#### Level 5 Features: 
> [!paladin-feature] Extra Attack
You can attack twice instead of once whenever you take the Attack action on your turn.

> [!paladin-feature] Faithful Steed
...
---
#### Level 10 Features: 
> [!paladin-feature] Aura of Courage
...
This section presents the Paladin spell list.  
The spells are organized by spell level and then alphabetized, and each spell’s school of magic is listed.  
In the **Special** column, **C** means the spell requires *Concentration*, **R** means it’s a *Ritual*, and **M** means it requires a specific *Material component*.
