---
{"dg-publish":true,"permalink":"/player-options/classes/sorcerer/sorcerer-sub-classes/shadow-sorcerer/"}
---
...
In addition, if a spell you cast creates an area of [[Darkness\|Darkness]], you can see normally through that spell's Darkness.
...
| -------------- | ------------------------------------------------------------------ |
| 3              | [[Player Options/Spells/Detailed Spells/Bane\|Bane]], [[Darkness\|Darkness]], [[Inflict Wounds\|Inflict Wounds]], [[Pass Without Trace\|Pass Without Trace]] |
...
You can cast [[Summon Undead\|Summon Undead]] without a Material component. You can also cast it once without a spell slot, and you regain the ability to cast it in this way when you finish a Long Rest. 
