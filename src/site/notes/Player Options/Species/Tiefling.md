...
A tieflingek vagy az Alsóbb Síkokon születnek, vagy olyan démoni ősökkel rendelkeznek, akik onnan származnak. A tiefling (ejtsd: _tí-fling_) vérségi köteléken keresztül kapcsolódik egy ördöghöz, démonhoz vagy más **Fendi** lényhez. Ez az Alsóbb Síkokhoz fűződő kapcsolat a tiefling démoni öröksége, amely hatalom ígéretét hordozza magában, ugyanakkor nincs hatással a tiefling erkölcsi beállítottságára.

#### Démoni Örökség

Egy tiefling maga dönt arról, hogy elfogadja vagy inkább siratja démoni örökségét. Az alábbiakban három különböző örökség kerül bemutatásra.

> [!tip] _**Abysszális**_  
> Az Abysszus entrópiája, Pandemonium káosza és Carceri kétségbeesése szólítja azokat a tieflingeket, akik az abysszális örökséggel rendelkeznek. Az ilyen tieflingeknél gyakoriak a szarvak, a szőrzet, az agyarak és a különös szagok; legtöbbjük ereiben démoni vér csörgedezik.

> [!tip] _**Khtonikus**_  
> A khtonikus örökséggel bíró tieflingek nemcsak Carceri vonzását érzik, hanem Gehenna kapzsiságát és Hades komorságát is. Némelyikük halottszerű megjelenésű. Mások természetfeletti szépséggel rendelkeznek, akár egy succubus, vagy fizikai jegyeket hordoznak, amelyek egy night haggel, yugolothtal vagy más Semleges Gonosz fendi őssel közösek.

> [!tip] _**Infernáli**_  
> Az infernáli örökség a tieflingeket nemcsak Gehenna síkjához köti, hanem a Kilenc Pokolhoz és Acheron tomboló csatatereihez is. Az ilyen tieflingeknél gyakoriak a szarvak, tüskék, farkak, aranyszínű szemek, valamint a kén vagy füst enyhe szaga; többségük ördögi ősöktől származtatja magát.

Egy olyan örökség hordozója vagy, amely természetfeletti képességekkel ruház fel. Válassz egy örökséget a **Démoni Örökségek** táblázatból. Megkapod a választott örökség 1. szintű előnyét.

Amikor eléred a 3. és az 5. karakter-szintet, egy magasabb szintű varázslatot tanulsz meg, ahogy az a táblázatban szerepel. Ezeket a varázslatokat mindig előkészítve ismered. Egyszer elvarázsolhatod őket varázslathely felhasználása nélkül, és ezt a képességet visszanyered, amikor befejezel egy Hosszú Pihenést. A varázslatokat a megfelelő szintű varázslathelyeiddel is elvarázsolhatod. Az ezen tulajdonság révén használt varázslatok varázshasználati képessége az **Intelligencia**, **Bölcsesség** vagy **Karizma** (ezt a képességet az örökség kiválasztásakor döntöd el).
...
**Lény Típusa:** Humanoid  
**Méret:** Közepes (kb. 4–7 láb magas) vagy Kicsi (kb. 3–4 láb magas), a faj kiválasztásakor eldöntve  
**Sebesség:** 30 láb
