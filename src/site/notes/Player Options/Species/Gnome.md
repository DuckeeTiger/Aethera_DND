---
{"dg-publish":true,"permalink":"/player-options/species/gnome/"}
---
...
> [!tip] **Forest Gnome.** [[[[\|[[]]]]
You know the [[Player Options/Spells/Detailed Spells/Minor Illusion\|Minor Illusion]] cantrip. You also always have the [[Player Options/Spells/Detailed Spells/Speak with Animals\|Speak with Animals]] spell prepared. You can cast it without a spell slot a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest. You can also use any spell slots you have to cast the spell.
