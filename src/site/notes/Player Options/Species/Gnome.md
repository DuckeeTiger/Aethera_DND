---
{"dg-publish":true,"permalink":"/player-options/species/gnome/","created":"2025-10-27T17:24:25.000+01:00","updated":"2025-11-05T13:09:26.106+01:00"}
---
...
> [!tip] **Forest Gnome.** [[[[\|[[]]]]
You know the [[Player Options/Spells/Detailed Spells/Minor Illusion\|Minor Illusion]] cantrip. You also always have the [[Speak with Animals\|Speak with Animals]] spell prepared. You can cast it without a spell slot a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest. You can also use any spell slots you have to cast the spell.

> [!tip] **Rock Gnome.** 
> You know the [[Player Options/Spells/Detailed Spells/Mending\|Mending]] and [[Player Options/Spells/Detailed Spells/Prestidigitation\|Prestidigitation]] cantrips. In addition, you can spend 10 minutes casting *[[Player Options/Spells/Detailed Spells/Prestidigitation\|Prestidigitation]]* to create a Tiny clockwork device (AC 5, 1 HP), such as a toy, fire starter, or music box. When you create the device, you determine its function by choosing one effect from *[[Player Options/Spells/Detailed Spells/Prestidigitation\|Prestidigitation]]*; the device produces that effect whenever you or another creature takes a Bonus Action to activate it with a touch. If the chosen effect has options within it, you choose one of those options for the device when you create it. For example, if you choose the spell’s ignite-extinguish effect, you determine whether the device ignites or extinguishes fire; the device doesn’t do both. You can have three such devices in existence at a time, and each falls apart 8 hours after its creation or when you dismantle it with a touch as a Utilize action.
