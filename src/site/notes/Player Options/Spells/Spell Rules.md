---
{"dg-publish":true,"permalink":"/player-options/spells/spell-rules/","created":"2025-10-30T08:15:23.000+01:00","updated":"2025-11-04T11:23:29.969+01:00"}
---

## Gaining Spells

Before you can cast a spell, you must have the spell prepared in your mind or have access to the spell from a magic item, such as a [Spell Scroll](ddb://magicitems/9229085). Your features specify which spells you have access to, if any; whether you always have certain spells prepared; and whether you can change the list of spells you have prepared.

### [](ddb://compendium/br-2024/spells#GainingSpells#PreparingSpells)Preparing Spells
...
### [](ddb://compendium/br-2024/spells#GainingSpells#SpellPreparationbyClass)Spell Preparation by Class
...
### [](ddb://compendium/br-2024/spells#GainingSpells#AlwaysPreparedSpells)Always-Prepared Spells
...
Each [spell description](ddb://compendium/br-2024/spell-descriptions) has a series of entries that provide the details needed to cast the spell. The following sections explain each of those entries, which follow a spell’s name.

### [](ddb://compendium/br-2024/spells#CastingSpells#SpellLevel)Spell Level
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#SpellSlots)Spell Slots
...
**Magic Items.** [Spell Scrolls](ddb://magicitems/9229085) and some other magic items contain spells that can be cast without a spell slot. The description of such an item specifies how many times a spell can be cast from it.

#### [](ddb://compendium/br-2024/spells#CastingSpells#UsingaHigherLevelSpellSlot)Using a Higher-Level Spell Slot

When a spellcaster casts a spell using a slot that is of a higher level than the spell, the spell takes on the higher level for that casting. For instance, if a Wizard casts [Magic Missile](ddb://spells/2619022)using a level 2 slot, that _Magic Missile_ is level 2. Effectively, the spell expands to fill the slot it is put into.

Some spells, such as [Magic Missile](ddb://spells/2619022) and [Cure Wounds](ddb://spells/2619079), have more powerful effects when cast at a higher level, as detailed in a spell’s description.

### [](ddb://compendium/br-2024/spells#CastingSpells#SchoolofMagic)School of Magic
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#SchoolsofMagic)Schools of Magic
...
### [](ddb://compendium/br-2024/spells#CastingSpells#ClassSpellLists)Class Spell Lists
...
### [](ddb://compendium/br-2024/spells#CastingSpells#CastingTime)Casting Time

Most spells require the [Magic](ddb://actions/2) action to cast, but some spells require a Bonus Action, a Reaction, or 1 minute or more. A spell’s Casting Time entry specifies which of those is required.

#### [](ddb://compendium/br-2024/spells#CastingSpells#OneSpellwithaSpellSlotperTurn)One Spell with a Spell Slot per Turn

On a turn, you can expend only one spell slot to cast a spell. This rule means you can’t, for example, cast a spell with a spell slot using the [Magic](ddb://actions/2) action and another one using a Bonus Action on the same turn.

#### [](ddb://compendium/br-2024/spells#CastingSpells#ReactionandBonusActionTriggers)Reaction and Bonus Action Triggers
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#LongerCastingTimes)Longer Casting Times

Certain spells—including a spell cast as a [Ritual](ddb://rulesglossary/96)—require more time to cast: minutes or even hours. While you cast a spell with a casting time of 1 minute or more, you must take the [Magic](ddb://actions/2) action on each of your turns, and you must maintain [Concentration](ddb://rulesglossary/31) (see the [Rules Glossary](ddb://compendium/br-2024/rules-glossary#RulesDefinitions#Concentration)) while you do so. If your Concentration is broken, the spell fails, but you don’t expend a spell slot. To cast the spell again, you must start over.

### [](ddb://compendium/br-2024/spells#CastingSpells#Range)Range
...
### [](ddb://compendium/br-2024/spells#CastingSpells#Components)Components
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#VerbalV)Verbal (V)
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#SomaticS)Somatic (S)

A Somatic component is a forceful gesticulation or an intricate set of gestures. A spellcaster must use at least one of their hands to perform these movements.

#### [](ddb://compendium/br-2024/spells#CastingSpells#MaterialM)Material (M)

A Material component is a particular material used in a spell’s casting, as specified in parentheses in the Components entry. These materials aren’t consumed by the spell unless the spell’s description states otherwise. The spellcaster must have a hand free to access them, but it can be the same hand used to perform Somatic components, if any.

If a spell doesn’t consume its materials and doesn’t specify a cost for them, a spellcaster can use a [Component Pouch](ddb://adventuring-gear/538) (see “[Equipment](ddb://compendium/br-2024/equipment#AdventuringGear#ComponentPouch25GP)”) instead of providing the materials specified in the spell, or the spellcaster can substitute a Spellcasting Focus if the caster has a feature that allows that substitution. To use a Component Pouch, you must have a hand free to reach into it, and to use a Spellcasting Focus, you must hold it unless its description says otherwise (see “[Equipment](ddb://compendium/br-2024/equipment)” for descriptions).

### [](ddb://compendium/br-2024/spells#CastingSpells#Duration)Duration
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#Targets)Targets
...
**_A Clear Path to the Target._** To target something with a spell, a caster must have a clear path to it, so it can’t be behind [Total Cover](ddb://rulesglossary/33).

**_Targeting Yourself._** If a spell targets a creature of your choice, you can choose yourself unless the creature must be [Hostile](ddb://rulesglossary/70) or specifically a creature other than you.

**_Areas of Effect._** Some spells, such as [Thunderwave](ddb://spells/2619184), cover an area called an [area of effect](ddb://rulesglossary/8), which is defined in the [Rules Glossary](ddb://compendium/br-2024/rules-glossary#RulesDefinitions#AreaofEffect). The area determines what the spell targets. The description of a spell specifies whether it has an area of effect, which is typically one of these shapes: [Cone](ddb://rulesglossary/17), [Cube](ddb://rulesglossary/38), [Cylinder](ddb://rulesglossary/40), [Emanation](ddb://rulesglossary/54), [Line](ddb://rulesglossary/80), or [Sphere](ddb://rulesglossary/109).
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#SavingThrows)Saving Throws
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#AttackRolls)Attack Rolls
...
#### [](ddb://compendium/br-2024/spells#CastingSpells#CombiningSpellEffects)Combining Spell Effects

The effects of different spells add together while their durations overlap. In contrast, the effects of the same spell cast multiple times don’t combine. Instead, the most potent effect—such as the highest bonus—from those castings applies while their durations overlap. The most recent effect applies if the castings are equally potent and their durations overlap. For example, if two Clerics cast [Bless](ddb://spells/2618933) on the same target, that target gains the spell’s benefit only once; the target doesn’t receive two bonus dice. But if the durations of the spells overlap, the effect continues until the duration of the second _Bless_ ends.